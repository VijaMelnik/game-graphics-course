...
let vertexShader = `
    ...
    {
<<<<<<< HEAD
        gl_Position = modelViewProjectionMatrix * vec4(position, 0.30);           
=======
...
loadImages(["images/filipp.jpg", "images/cubemap.jpg"], function (images) {
...
>>>>>>> upstream/example
        ...
        mat4.perspective(projMatrix, Math.PI / 2, app.width / app.height, 0.1,0); 
        let camPos = vec3.rotateY(vec3.create(), vec3.fromValues(0, 0, 0), vec3.fromValues(0, 0, 0), time * 0.05);
        mat4.lookAt(viewMatrix, camPos, vec3.fromValues(0, 0, 0), vec3.fromValues(0, 5, 0));
        mat4.multiply(viewProjMatrix, projMatrix, viewMatrix);
        ...
        let skyboxView = mat4.clone(viewMatrix);        mat4.setTranslation(skyboxView, vec3.fromValues(0, 0, 0));        let skyboxViewProjectionMatrix = mat4.create();
